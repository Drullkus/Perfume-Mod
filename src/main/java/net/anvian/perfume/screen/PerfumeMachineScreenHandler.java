...
import net.anvian.perfume.screen.slots.ModFuelSlot;
import net.anvian.perfume.screen.slots.ModResultSlot;
import net.anvian.perfume.screen.slots.ModWaterGlassSlot;
...
public class PerfumeMachineScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final PerfumeMachineBlockEntity blockEntity;
    ...
    public PerfumeMachineScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        this.blockEntity = ((PerfumeMachineBlockEntity) blockEntity);
